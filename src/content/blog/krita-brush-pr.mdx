...
description: "From zero C++ to getting a PR merged into Krita (an open source painting app)."
pubDate: "2021-08-01"
published: true
cover: "src/assets/posts/krita-demon-summoning.png"
...
import localImage from "src/assets/posts/krita-demon-summoning.png"

import { Image } from 'astro:assets'

<Image src={localImage} quality="100" alt="" format="png"/>
